...
<style>
  ...
  *,*::before,*::after{{box-sizing:border-box;margin:0;padding:0}}
  ...
  .offline-fallback{{display:none;margin:32px auto;padding:20px;max-width:720px;background:#fff;border:1px solid #d0d7de;border-radius:8px;color:#24292f;line-height:1.5}}
  .offline-fallback h2{{font-size:18px;margin-bottom:8px;color:#0d1117}}
  .offline-fallback code{{background:#f6f8fa;border:1px solid #d0d7de;border-radius:4px;padding:2px 5px}}
...
<div id="offlineFallback" class="offline-fallback">
  <h2>Mindmap libraries could not be loaded</h2>
  <p>This exported mindmap needs access to <code>cdn.jsdelivr.net</code> to load D3 and Markmap. Reconnect to the internet or allow the CDN, then reopen this file.</p>
</div>
<footer>
...
if (!window.d3 || !window.markmap) {{
  showOfflineFallback();
  throw new Error('Mindmap CDN libraries are unavailable');
}}
