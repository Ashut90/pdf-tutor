...
<style>
  ...
  h1 {{ color: #58a6ff; }}
  .mermaid {{ background: #161b22; padding: 20px; border-radius: 8px; }}
</style>
<script type="module">
...
<footer style="margin-top:40px;font-size:0.75em;color:#8b949e;text-align:center">
  Generated by <a href="https://github.com/Ashut90/pdf-tutor" style="color:#58a6ff">PDF Tutor</a>
</footer>
</body></html>"""
                with open(path, "w", encoding="utf-8") as f:
                    f.write(html)
